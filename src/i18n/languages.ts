...
export const UI_STRINGS: Record<AppLanguage, UiStrings> = {
  id: {
    ...
    jurnalLoginTitle: 'Masuk dengan Google',
    jurnalLoginDesc:
      'Akun Google diperlukan agar langganan Jurnal terhubung ke email Anda.',
    jurnalLoginFailed: 'Login Google gagal. Coba lagi.',
  ...
  ko: {
    ...
    jurnalLoginTitle: 'Google로 로그인',
    jurnalLoginDesc: '구독을 이메일에 연결하려면 Google 계정이 필요합니다.',
    jurnalLoginFailed: 'Google 로그인에 실패했습니다.',
  ...
  ms: {
    ...
    jurnalLoginTitle: 'Log masuk dengan Google',
    jurnalLoginDesc: 'Akaun Google diperlukan untuk menghubungkan langganan.',
    jurnalLoginFailed: 'Log masuk Google gagal.',
  ...
  uz: {
    ...
    jurnalLoginTitle: 'Google orqali kirish',
    jurnalLoginDesc: 'Obunani emailga bog\'lash uchun Google hisobi kerak.',
    jurnalLoginFailed: 'Google orqali kirish muvaffaqiyatsiz.',
