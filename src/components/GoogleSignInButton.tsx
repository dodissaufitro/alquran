...
/** APK — jangan panggil useGoogleLogin (membutuhkan GoogleOAuthProvider yang sengaja tidak dipasang di main.tsx). */
...
function GoogleSignInButtonWeb({ onError, onSuccess, showWidget = true }: Props) {
  ...
  const showGisWidget = showWidget && !widgetFailed
